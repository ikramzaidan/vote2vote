                ...
                <div class="card">
                    <div class="card-body">
                        <form class="user mt-4">
                            ...
                            <div class="form-group">
                                <label>Name</label>
                                <input type="text" class="form-control form-control-user" value="<?=$name?>" readonly>
                            </div>
                            <div class="form-group">
                                <label>Username</label>
                                <input type="text" class="form-control form-control-user" value="<?=$usrn?>" readonly>
                            </div>
                            <div class="form-group">
                                <label>Angkatan</label>
                                <input type="text" class="form-control form-control-user" value="<?=$desc?>" readonly>
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control form-control-user text-white <?php if($section==2):echo"bg-success";else:echo"bg-danger";endif?>"
                                 value="<?php if($section==2):echo"Sudah Memilih";else:echo"Belum Memilih";endif?>" readonly>
                            </div>
                        </form>
                    </div>
                </div>
